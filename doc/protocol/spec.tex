...
if Chain ~= nil then goto 5 end
Chain = signChainFor(ServerLogin) 
cache.SignedChains.put(Chain)
if InvalidLogins then NO_PERMISSION{minor=InvalidTarget} end
CORBAException then NO_PERMISSION{minor=UnavailableBus} end
...
switch(minor)
  ...
  case InvalidLogin:
    if login == conn.login().id then localLogout() end
